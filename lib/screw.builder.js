var Screw = (function($) {
  ...
  screw.Describe = function(parent, name, fn, element) {
    ...
    this.describe = function(name, fn) {
      try {
        return append_to(this.describes, new Screw.Describe(Screw.current_describe, name, fn));
      } finally {
        Screw.current_describe = this;
      }
    }
    ...
    this.it = function(name, fn) {
      return append_to(this.its, new Screw.It(this, name, fn));
    }

    this.before = function(fn) {
      return append_to(this.befores, new Screw.Before(this, fn));
    }

    this.after = function(fn) {
      return append_to(this.afters, new Screw.After(this, fn));
    }
    ...
    append_to = function(collection, item) {
